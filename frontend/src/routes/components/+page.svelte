		...
		main: {
			about: {
				...
				content: [
					...
					`Technology has allowed us to visit and populate a vast digital frontier. We've learned to navigate freeways of light through mouse and keyboard, engaging in the largest celebration of creativity, innovation, and human connection that has ever existed. An ever-expanding and evolving "<a href="/declaration_of_the_independence_of_cyberspace.pdf" target="_blank">civilization of the Mind</a>"...`,
...
<div>
	...
	/>
	<Header gridarea="headnav" data={data.header} />
	<main>
